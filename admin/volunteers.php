...
<html lang="en">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><a href="update.php?update=<?php echo $id; ?>" class="btn btn-info">Update</a></td>
            <td><a href="../admin/volunteers.php?delete=<?php echo $id; ?>" class="btn btn-danger">Delete</a></td>
        </tr>
        <?php }}else{
