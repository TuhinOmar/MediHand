            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Request status</h1>
...
<div class="row">
    ...
    <table class="table table-bordered text-center">
        ...
        <?php
            ...
            $query = "SELECT SUM(served) FROM volunteers";
            $readquery = mysqli_query($conn, $query);
            $rd = mysqli_fetch_array($readquery);
            $totServed = $rd[0];

            $query = "SELECT MAX(served) as mx FROM volunteers";
            $readquery = mysqli_query($conn, $query);
            $rd = mysqli_fetch_array($readquery);
            $mxServed = $rd['mx'];
            $query = "SELECT username FROM volunteers WHERE served = '$mxServed'";
            $readquery = mysqli_query($conn, $query);
            $rd = mysqli_fetch_array($readquery);
            $topVol = $rd['username'];
        ...
        <tr class="table-secondary py-5">
            <td>Toatal served</td>
            <td><?php echo $totServed; ?></td>
        </tr>
        <tr class="table-success py-5">
            <td>Top volunteer</td>
            <td><?php echo $topVol; ?></td>
        </tr>
