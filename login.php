        ...
        <form method="post">
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <button type="submit" class="btn btn-primary btn-lg"
              style="padding-left: 2.5rem; padding-right: 2.5rem;" name="btn_login">Login</button>
...
if(isset($_POST['btn_login'])){
  $query = "SELECT * FROM volunteers WHERE username = '$_POST[username]' AND pass='$_POST[password]'";
